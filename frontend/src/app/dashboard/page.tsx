...
export const metadata = { title: 'Painel — Pavcon Licitações' };
    ...
    <div className="min-h-screen">
      <header className="border-b border-zinc-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <div>
            <h1 className="text-lg font-semibold text-zinc-900">Pavcon Licitações</h1>
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-xl font-semibold text-zinc-900">Licitações</h2>
          <Link
        ...
        {!error && (!licitacoes || licitacoes.length === 0) && (
          <div className="rounded-lg border border-dashed border-zinc-300 bg-white p-12 text-center">
            <p className="text-sm text-zinc-500">
              Nenhuma licitação cadastrada ainda. Clique em <strong>Nova licitação</strong> pra começar.
            </p>
          </div>
        )}
